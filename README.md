Hello!
This is my second attempt at making a 3d Graphics/Game engine from (almost) scratch, this time, I have decided to do it in C to make it a little more challenging.
If you want to run it on your pc, I advise you to make a Makefile on your own (or to run it with gcc and the same librairies as in my makefile).
